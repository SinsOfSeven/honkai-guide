...
const bossToChinese = {
  ...
  "MHT-3B (new tank)": ["MHT-3B", "天堂使者"],
  "MR-06X Hephaestus": ["赫菲斯托斯", "灭火器"],
  "Nihilus Husk (clock)": ["虚树神骸", "lzx"],
...
const valkToChinese = {
  ...
  "Luna Kindred (LK)": ["月", "初"],
  "Memento (Meme)": ["勿"],
  "Midnight Absinthe (Raven)": ["午夜苦艾", "渡鸦"],
  Miko: ["逆"],
